...
class MaterialcatModel extends PublicModel {
    ...
    public function updateothercat($old_cat_no, $new_cat_no) {
        ...
        $es_product_model = new EsproductModel();
        $es_product_model->Updatemeterialcatno($old_cat_no, null, 'en');
        $es_product_model->Updatemeterialcatno($old_cat_no, null, 'zh');
        $es_product_model->Updatemeterialcatno($old_cat_no, null, 'es');
        $es_product_model->Updatemeterialcatno($old_cat_no, null, 'ru');
        return true;
    }
