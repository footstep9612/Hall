...
//put your code here
    ...
    private function getCondition($condition, $lang = 'en', &$country_bn = null, &$is_show_cat = false, &$show_cat_name = null, &$is_brand = false, &$brand_name = null) {
        ...
        $body['query']['bool']['must'][] = ['bool' => [ESClient::SHOULD => [
                    [ESClient::TERM => ['show_cats.cat_no1' => ['value' => '44:00:00', 'boost' => 2500]]],
                    [ESClient::TERM => ['show_cats.cat_no1' => ['value' => '46:00:00', 'boost' => 1000]]],
                    [ESClient::TERM => ['show_cats.cat_no1' => ['value' => '49:00:00', 'boost' => 10000]]],
                    [ESClient::TERM => ['show_cats.cat_no1' => ['value' => '53:00:00', 'boost' => 5000]]],
                    [ESClient::TERM => ['show_cats.cat_no2' => ['value' => '51:03:00', 'boost' => 500]]],
    ...
    public function getCatList($condition, $lang) {
        ...
        if (isset($condition['show_cat_no']) && $condition['show_cat_no']) {
            $show_cat = $show_cat_model->field('level_no,parent_cat_no')
                    ->where(['cat_no' => $condition['show_cat_no'], 'lang' => $lang])
                    ->find();
