...
//put your code here
    ...
    private function getCondition(&$condition, $lang = 'en') {
        ...
        ESClient::getQureyByArr($condition, $body, ESClient::MATCH_PHRASE, 'spus', 'spu');
        ...
        ESClient::getStatus($condition, $body, ESClient::MATCH_PHRASE, 'status', 'status', ['NORMAL', 'VALID', 'TEST', 'CHECKING', 'CLOSED', 'DELETED']);
...
//ESClient::getStatus($condition, $body, ESClient::MATCH_PHRASE, 'shelves_status', 'shelves_status', ['VALID', 'INVALID']);
        ESClient::getQurey($condition, $body, ESClient::WILDCARD, 'brand', 'brand.all');
        ...
        ESClient::getQurey($condition, $body, ESClient::MATCH_PHRASE, 'created_by');
        ESClient::getQurey($condition, $body, ESClient::MATCH_PHRASE, 'updated_by');
        ESClient::getQurey($condition, $body, ESClient::MATCH_PHRASE, 'checked_by');
        ESClient::getQurey($condition, $body, ESClient::MATCH_PHRASE, 'customization_flag', 'customization_flag.all');
        ESClient::getQurey($condition, $body, ESClient::MATCH_PHRASE, 'sku_count');
