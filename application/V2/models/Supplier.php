...
//    protected $autoCheckFields = false;
    ...
    public function getSkuSupplierList($condition = []){
        ...
        $sql = 'SELECT s.name,s.sec_ex_listed_on,s.sec_ex_listed_on,t.* FROM erui_supplier.supplier s ';
        $sql .= 'LEFT JOIN (SELECT gs.supplier_id,g.spu,gs.sku,gs.brand,p.price as purchase_unit_price,p.price_cur_bn as purchase_price_cur_bn,p.price_validity as period_of_validity,';
