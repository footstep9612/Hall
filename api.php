...
if (file_exists(MYPATH . DS . 'application' . DS . $module) && $module) {
    ...
    if (file_exists(MYPATH . DS . 'application' . DS . $module . DS . 'conf')) {
        define('CONF_PATH', MYPATH . DS . 'application' . DS . $module . DS . 'conf');
    } else {
        define('CONF_PATH', MYPATH . DS . 'conf');
    }
} else {
...
$application_path = CONF_PATH . DS . 'application.ini';
foreach ($environments as $environment) {
    if (file_exists('/var/conf/' . $environment)) {
        $application_path = CONF_PATH . DS . 'application_' . $environment . '.ini';
        break;
    }
}
/**
